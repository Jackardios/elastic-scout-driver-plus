...
class SearchParametersBuilder
{
    ...
    /**
     * @var array<string, callable(Collection): Collection>
     */
     ...
     * @return $this
     */
    public function setEloquentQueryCallback(Closure $callback, string $modelClass = null): self
    {
        $indexName = $this->resolveJoinedIndexName($modelClass);
     ...
     * @return $this
     */
    public function setEloquentCollectionCallback(Closure $callback, string $modelClass = null): self
    {
        $indexName = $this->resolveJoinedIndexName($modelClass);
        $this->eloquentCollectionCallbacks[$indexName] = $callback;
    ...
    public function execute(): SearchResult
    {
        ...
        $modelFactory = (new ModelFactory($this->databaseQueryBuilders))
            ->withSearchResult($baseSearchResult)
            ->withEloquentCollectionCallbacks($this->eloquentCollectionCallbacks);
